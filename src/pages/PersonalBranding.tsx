...
import { ArrowLeft, Award, Mic, Globe, Users } from 'lucide-react';
...
export default function PersonalBranding() {
  ...
  return (
    <div className="min-h-screen bg-[#0000] text-white font-sans selection:bg-[#00d2ff] selection:text-black relative overflow-x-hidden">
      ...
      {/* Header */}
      <header className="fixed top-0 w-full bg-[#0004] flex justify-between items-center p-6 md:p-8 z-50 border-b border-white/5">
        <button 
          onClick={() => navigate('/')}
          className="flex items-center gap-2 text-white/60 hover:text-[#00d2ff] transition-colors group font-sans"
        >
          <ArrowLeft size={20} className="group-hover:-translate-x-1 transition-transform" />
          <span className="text-[clamp(0.65rem,1vw,0.75rem)] tracking-[0.1em] uppercase font-bold">Trang chủ</span>
        </button>
        
        <button 
          onClick={() => setIsContactOpen(true)}
          className="px-6 py-2.5 bg-transparent border border-[#00d2ff] text-[#00d2ff] rounded-full text-[clamp(0.65rem,1vw,0.75rem)] tracking-widest uppercase hover:bg-[#00d2ff] hover:text-black transition-colors font-bold"
        >
          Tư vấn ngay
        </button>
      </header>
      ...
      <main className="relative z-10">
        ...
        <section className="min-h-screen flex items-center px-6 md:px-12 max-w-[1600px] mx-auto pt-20">
          <div className="max-w-3xl">
            ...
            <motion.h1 
              ...
              className="text-[clamp(2.5rem,6vw,6rem)] font-black tracking-tighter text-white leading-[1.1] uppercase"
            >
            ...
            <motion.p 
              ...
              className="mt-8 text-[clamp(0.875rem,1.5vw,1rem)] text-white/60 leading-relaxed max-w-md font-mono uppercase tracking-widest"
            >
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto text-center border-t border-white/10 relative z-10 bg-[#0a1118]/80 backdrop-blur-md rounded-3xl mt-20 overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-[clamp(0.75rem,1vw,0.875rem)] font-bold tracking-[0.2em] uppercase text-[#00d2ff] mb-8">Insight</h2>
            <h3 className="text-[clamp(2rem,4vw,3rem)] font-black mb-12 uppercase tracking-tight">
              Thế giới đang chuyển từ:<br/>
              <span className="text-white/50">Brand Trust → Human Trust</span>
            </h3>
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-16">
              {[
                { role: 'Founder', img: 'https://images.unsplash.com/photo-1556761175-5973dc0f32b7?q=80&w=800&auto=format&fit=crop' },
                { role: 'Expert', img: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=800&auto=format&fit=crop' },
                { role: 'Leader', img: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?q=80&w=800&auto=format&fit=crop' }
              ].map((item, i) => (
        ...
        <section className="py-32 px-6 relative z-10">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
            ...
            <div className="order-1 md:order-2">
              <h2 className="text-[clamp(0.75rem,1vw,0.875rem)] font-bold tracking-[0.2em] uppercase text-[#00d2ff] mb-8">Solution</h2>
              <h3 className="text-[clamp(2.5rem,5vw,4rem)] font-black mb-12 leading-[1.1] uppercase tracking-tighter">
                CHQ giúp bạn xây dựng <br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d2ff] to-blue-500">Video Personal Brand System</span>
              </h3>
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto relative z-10">
          <h2 className="text-[clamp(0.75rem,1vw,0.875rem)] font-bold tracking-[0.2em] uppercase text-[#00d2ff] mb-8 text-center">Outcome</h2>
        ...
        <section className="py-32 px-6 max-w-4xl mx-auto text-center border-t border-white/10 relative z-10">
          <h2 className="text-[clamp(0.75rem,1vw,0.875rem)] font-bold tracking-[0.2em] uppercase text-[#00d2ff] mb-16">Who is this for</h2>
          <div className="flex flex-wrap justify-center gap-4 mb-32">
            {['CEO', 'Founder', 'CXO', 'Manager', 'Expert'].map((tag, i) => (
