...
export default function GlobalAudioPlayer() {
  ...
  const isArtBranding = location.pathname === '/art-branding';

  return (
    <div className={`fixed z-[100] transition-all duration-500 ${isArtBranding ? 'bottom-8 left-1/2 -translate-x-1/2' : 'bottom-8 left-8'}`}>
      <audio 
        ref={audioRef} 
        src="
https://raw.githubusercontent.com/Cam0411/music__9/refs/heads/main/ES_Deeper%20Still%20-%20Alan%20Ellis.mp3" 
        loop 
      />
      <button 
        onClick={togglePlay}
